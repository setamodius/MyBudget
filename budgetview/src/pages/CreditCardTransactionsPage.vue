...
function deneme() {
  api
    .get("/creditcard/" + selectedbank.value.id + "/transactions")
    .then((response) => {
...
function addRow() {
  api
    .post(
      "/creditcard/" + selectedbank.value.id + "/transactions",
      editedItem.value
    )
    .then((response) => {
      $q.notify({
...
function deleteItem(row) {
  api
    .delete("/creditcard/" + selectedbank.value.id + "/transactions/" + row.id)
    .then((response) => {
      $q.notify({
        color: "positive",
        position: "top",
...
function editItem(row) {
  api
    .put(
      "/creditcard/" + selectedbank.value.id + "/transactions/" + row.id,
      row
    )
    .then((response) => {
      $q.notify({
